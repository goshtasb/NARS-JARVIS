...
> **⚠ SUPERSEDED-IN-DIRECTION (2026-06-15):** this is the **v1 as-built** record of the general assistant
> (chat / habits / Sentinel / overnight — shipped, ~780 tests). The product is pivoting to a zero-leak
> **contract-review** focus; the new directional source of truth is [PRD.md](PRD.md). This document is kept
> as the accurate record of what was actually built and is NOT deleted. Where the two conflict on *direction*,
> PRD.md wins; on *what currently exists today*, this document is accurate.
